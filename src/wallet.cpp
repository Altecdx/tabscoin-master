...
// tabscoin: total coins staked (non-spendable until maturity)
...
// tabscoin: check 'spent' consistency between wallet and txindex
// tabscoin: fix wallet spent state according to txindex
...
// tabscoin: disable transaction (only for coinstake)
